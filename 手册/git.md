...
请注意，支持 XP 的最后一个版本是`Git-2.10.0`（[下载](https://github.com/git-for-windows/git/releases/download/v2.10.0.windows.1/PortableGit-2.10.0-32-bit.7z.exe)），支持 WIN7 的最后一个版本是`Git-2.36.1`（[下载](https://github.com/git-for-windows/git/releases/download/v2.36.1.windows.1/PortableGit-2.36.1-64-bit.7z.exe)）。
